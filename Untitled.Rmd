...
dataFinal <- read.csv("/Users/arihangupta/Downloads/PhiCB5-Analysis-2023/finalData.csv")
...
dataFinal <- cbind(dataFinal, id = paste(toString(dataFinal[, 7]), toString(dataFinal[, 8]), toString(dataFinal[, 9])))
...
```{r}
p1 <- ggplot(data = dataFinal, mapping = aes(x= avgInt)) + geom_histogram() + facet_wrap(~cond)
p1
```
## Including Plots
